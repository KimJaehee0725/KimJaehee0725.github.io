...
- 정적인 과제를 넘어, 언어 모델이 어떻게 추론하고 검색하고 시간 속에서 작동하는지를 연구합니다.
- LLM reasoning과 강화학습, 시간 속에서 작동하는 에이전트, 외부 정보로 향하는 retrieval을 두루 다룹니다.
- ICML, NeurIPS, ACL, EMNLP, CVPR workshop 등 ML/NLP 주요 학회에 논문을 발표했습니다.
